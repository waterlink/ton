module Ton
  Universe.create(TEST_BATTLE_WORLD) do
    ...
    player.tile_color = Components::TileColor.new(0)
    ...
    goblin4 = Entity.new
    goblin4.name = Components::Name.new("Dakka")
    goblin4.enemy = Components::Enemy.new(true)
    goblin4.tile = Components::Tile.new("g")
    goblin4.tile_color = Components::TileColor.new(5)
    goblin4.position = Components::Position.new(-7, 0)
    goblin4.blocks_movement = Components::BlocksMovement.new(true)
    goblin4.energy = Components::Energy.new(0, 100)
    goblin4.energy_restoration = Components::EnergyRestoration.new(0.25)
    goblin4.movement_energy_cost = Components::MovementEnergyCost.new(20)
    goblin4.health = Components::Health.new(50, 50)
    goblin4.attack_energy_cost = Components::AttackEnergyCost.new(70)
    goblin4.attack_range = Components::AttackRange.new(2)
    goblin4.damage = Components::Damage.new(15)
